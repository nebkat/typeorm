        ...
        if (this.metadata.treeType === "closure-table") {
            ...
            return this
                ...
                .where(qb => {
                    ...
                    const like = this.manager.connection.driver.abilities.concatOperator ? `${query} || '%'` : `CONCAT(${query}, '%')`;
        ...
        if (this.metadata.treeType === "closure-table") {
            ...
            return this
                ...
                .where(qb => {
                    ...
                    const query = subQuery.getQuery();
                    const column = `${alias}.${this.metadata.materializedPathColumn!.propertyPath}`;
                    const like = this.manager.connection.driver.abilities.concatOperator ? `${column} || '%'` : `CONCAT(${column}, '%')`;
